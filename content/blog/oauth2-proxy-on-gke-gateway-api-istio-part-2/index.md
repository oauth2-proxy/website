...
title: "OAuth2 Proxy on GKE with Gateway API + Istio: Part 2"
summary: "Configuring OAuth2 Proxy as an Istio extension provider in a GKE Gateway API deployment."
author: "Jan Larwig"
author_url: "https://github.com/tuunit"
author_avatar: "https://avatars.githubusercontent.com/u/18513179?v=4"
---

This is the second part of "[GKE with Gateway API + Istio](/blog/gke-gateway-api-istio/)" on how to properly utilize GKE Gateway API + Istio Gateway API.
Furthermore, it build upon the authorization setup with OAuth2 Proxy demonstrated in [Gateway API + Istio + OAuth2 Proxy](/blog/gateway-api-istio-oauth2-proxy/)
